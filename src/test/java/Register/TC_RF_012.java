...
public class TC_RF_012 {
	...
	public void registeringAccountUsingKeyboard() throws InterruptedException {
		...
		Thread.sleep(3000);
		action.sendKeys(email).pause(Duration.ofSeconds(2)).sendKeys(Keys.TAB).sendKeys("8280828585").sendKeys(Keys.TAB)
				.sendKeys("Pass@12345").sendKeys(Keys.TAB).sendKeys("Pass@12345").sendKeys(Keys.TAB)
